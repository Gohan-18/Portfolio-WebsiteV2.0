        ...
        <div className=" flex h-full w-full flex-col items-center justify-center mt-24 gap-5">
          ...
          {projects.map((item) => {
            return (
              <div
                key={item.title}
                className="animate__animated animate__fadeIn animate__delay-1s flex w-full max-w-4xl flex-wrap items-start justify-start gap-6 border-orange-600 rounded transition-all duration-500  md:border-blue bg-wht md:bg-gray-300 py-6 px-4 odd:border-r-4 even:flex-row-reverse even:border-l-4 md:rounded-lg md:px-10 md:py-10"
              >
