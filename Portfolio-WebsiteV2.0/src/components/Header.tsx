...
const Header = () => {
  ...
  return (
    <>
      <section className="z-5 animate__animated animate__fadeIn flex h-screen w-full flex-wrap justify-center bg-polygon-bg object-cover bg-dark-blue  bg-no-repeat px-4 lg:px-14">
