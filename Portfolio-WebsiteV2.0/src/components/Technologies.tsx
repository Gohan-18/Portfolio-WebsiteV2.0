...
const Technologies = () => {
  ...
  return (
    <>
      ...
      <section className="z-5 padding-top :h-screen flex w-full items-center justify-center bg-dark-blue px-4 pb-12 transition-all duration-500 sm:px-10 md:px-14 ">
        <div className=" flex-Wrap flex h-full w-full flex-col items-center justify-center ">
          ...
          <div className="animate__animated animate__fadeIn animate__delay-1s bg- flex h-full w-full  max-w-4xl  flex-col items-center justify-center gap-1 rounded border-t-4 border-orange-400 md:border-orange-500 py-6 px-4 text-sm transition-all duration-500 sm:text-base md:gap-3 md:rounded-lg md:border-t-8 md:bg-gray-200 md:px-10 md:py-10 lg:flex-row">
            <div className="animate__animated animate__fadeIn animate__delay-1s md:w-lg  grid w-full max-w-sm grid-cols-3 grid-rows-4 items-center justify-items-center gap-6 border-b-4 border-slate-200 px-4 pt-4 pb-7 md:border-indigo-800 lg:w-1/2 lg:border-b-0 lg:border-r-4">
              <div className="group relative flex h-full w-fit items-start justify-start transition-all duration-300">
              ...
              <div className="group relative flex h-full w-fit items-start justify-start transition-all duration-300">
                <SiVite
                  // title="Vite"
                  className="cursor-pointer rounded-lg bg-blue fill-wht p-3 text-5xl text-dark-blue transition-all duration-300  hover:bg-orange-500"
                />
                <span className="font-base invisible absolute h-full w-full cursor-pointer rounded-sm bg-orange-500 px-1 pt-1 font-poppins text-xxs leading-3 text-wht opacity-0 transition-all duration-300 group-hover:visible group-hover:opacity-100">
                  Vite
                </span>
            ...
            <div className="flex w-full max-w-sm flex-col items-center justify-start gap-2 pt-5 lg:w-1/2 lg:px-4 lg:pt-0  ">
              <p className="animate__animated animate__fadeIn animate__delay-1s h-full w-full rounded-xl text-justify font-poppins font-semibold capitalize text-wht md:text-slate-600">
              ...
              <p className="animate__animated animate__fadeIn animate__delay-1s h-full w-full rounded-xl text-justify font-poppins font-semibold capitalize text-wht md:text-slate-600">
                ...
                working with{" "}
                <span className="font-semibold text-orange-400 md:text-orange-600">ExpressJs</span>{" "}
                and{" "}
                <span className="font-semibold text-orange-400 md:text-orange-600">MongoDB</span>{" "}
